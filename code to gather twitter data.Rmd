...
```{r}
library(RCurl)
myfile <- getURL('http://www.wwbp.org/data.html/C.top100.1to3grams.gender_age_controlled.rmatrix.csv ', ssl.verifyhost=FALSE, ssl.verifypeer=FALSE)
...
myfile <- getURL('http://www.wwbp.org/data.html/A.top100.1to3grams.gender_age_controlled.rmatrix.csv ', ssl.verifyhost=FALSE, ssl.verifypeer=FALSE)
library_agreeableness <- read.csv(textConnection(myfile), header=T)
myfile <- getURL('http://www.wwbp.org/data.html/E.top100.1to3grams.gender_age_controlled.rmatrix.csv ', ssl.verifyhost=FALSE, ssl.verifypeer=FALSE)
library_extraversion <- read.csv(textConnection(myfile), header=T)
myfile <- getURL('http://www.wwbp.org/data.html/N.top100.1to3grams.gender_age_controlled.rmatrix.csv ', ssl.verifyhost=FALSE, ssl.verifypeer=FALSE)
